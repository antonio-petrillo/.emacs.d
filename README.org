...
#+begin_src emacs-lisp :tangle "lisp/init-elpaca-bootstrap.el"
...
#+begin_src emacs-lisp :tangle "lisp/init-emacs.el"
...
#+begin_src emacs-lisp :tangle "lisp/init-windows.el"
...
(use-package recentf
  :ensure nil
  :hook (elpaca-after-ini . recentf-mode))
#+end_src
...
#+begin_src emacs-lisp :tangle "lisp/init-jumps.el"
...
#+begin_src emacs-lisp :tangle "lisp/init-proj.el"
...
#+begin_src emacs-lisp :tangle "lisp/init-text-goodies.el"
...
#+begin_src emacs-lisp :tangle "lisp/init-strokes.el"
...
** Setup eshell
For now this section is a bit empty, I need to explore more the emacs shell.
Eshell is builtin.
#+begin_src emacs-lisp :tangle "lisp/init-eshell.el"
...
#+begin_src emacs-lisp :tangle "lisp/langs/clojure-setup.el"
...
*** Emacs Lisp
For now it is empty.
#+begin_src emacs-lisp :tangle "lisp/langs/emacs-lisp-setup.el"
...
#+begin_src emacs-lisp :tangle "lisp/langs/go-setup.el"
...
#+begin_src emacs-lisp :tangle "lisp/langs/odin-setup.el"
...
#+begin_src emacs-lisp :tangle "lisp/langs/zig-setup.el"
...
#+begin_src emacs-lisp :tangle "lisp/langs/ocaml-setup.el"
